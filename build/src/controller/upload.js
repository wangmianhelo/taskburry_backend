...
var UploadController = /** @class */ (function () {
    ...
    UploadController.prototype.uploadAvatar = function (req, res) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, user_1.updateAvatar(email, req.file.filename)];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/, res.status(200).json({ avatar: req.file.filename })];
                            }
                        });
                    });
                });
    ...
    __decorate([
        decorator_1.PostMapping('/upload/:email'),
